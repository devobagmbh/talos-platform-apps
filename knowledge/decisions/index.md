...
- [DR-0004 — Sanctioned RBAC-narrowing overlays](DR-0004-rbac-narrowing-overlay-sanction.md) - record a namespace-scoped RBAC narrowing as a supported consumer overlay in the component README, carry it in `compatibility.yaml rbac_policy`, and pin the grant a narrowing consumer binds against a committed golden via `task validate:rbac-narrowing` — rather than a second component or documentation alone. Accepted 2026-08-14.
