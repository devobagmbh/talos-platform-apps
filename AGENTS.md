...
- **Dokumentations-Standard**: Wie Docs, READMEs und Manifest-Kommentare geschrieben werden (BCP-14-Keywords MUST/SHOULD/MAY + Diátaxis-Doc-Typen pro Doc-Klasse; helm-docs `# --`-Kommentar-Konvention für `helm/*.yaml`-Values; nie einen konkreten Consumer benennen; Manifest-Kommentar-Policy) regelt [`DOCUMENTATION.md`](DOCUMENTATION.md) — die SOT fürs Doc-Authoring, geerdet in BCP 14 / Diátaxis / helm-docs / Standard-Readme. Jede Doc-Änderung wird semantisch dagegen reviewt.
